...
Геоинформационная система литературного картирования произведений русской литературы предназначена для загрузки любых текстов любыми пользователями, то есть результаты их обработки видны всем. Регистрация пользователей не предусмотрена, что не подходит ни к одному классу защиты автоматизированной системы. Система не требует от пользователя вносить персональные данные, поэтому безопасность не требуется.
