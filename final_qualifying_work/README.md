...
- Особенности работы с картографическими приложениями
...
// это уже требований.
// тут надо описать процессы, указанные выше.
...
// это опять-таки текущая ситуация.
...
// Надежность - это численный показатель.
...
// "расширение" - это ни о чем.
// важен формат файла.
// посмотрите, что такое на самом деле .doc и чем оно с технической 
// точки зрения отличается от docx.
...
// у вас ГИС. полюбому оно должно понимать метры-километры...
...
// вот тут ссылка на статью, что была в начале.
